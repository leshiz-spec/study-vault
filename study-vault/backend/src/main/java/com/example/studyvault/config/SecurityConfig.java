...
import com.example.studyvault.config.RequestLoggingFilter;
...
public class SecurityConfig {
    ...
    @Bean FilterRegistrationBean<RequestLoggingFilter> requestLoggingRegistration(RequestLoggingFilter filter) {
